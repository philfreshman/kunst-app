import { E as ElContainer, a as ElHeader, c as ElAside, b as ElMain } from './el-main-46fd43a6.mjs';
import { defineComponent, withCtx, createVNode, renderSlot, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderSlot } from 'vue/server-renderer';
import Navigation from './Navigation-482609f5.mjs';
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_el_aside, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(Navigation, null, null, _parent4, _scopeId3));
                      } else {
                        return [
...
//# sourceMappingURL=default-64172815.mjs.map
