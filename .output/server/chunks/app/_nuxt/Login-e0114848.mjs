import { ref, defineComponent, watch, renderSlot, computed, provide, reactive, toRefs, openBlock, createElementBlock, normalizeClass, unref, inject, onUpdated, createVNode, Fragment, useSlots, withCtx, createBlock, resolveDynamicComponent, normalizeStyle, createTextVNode, toDisplayString, createCommentVNode, createElementVNode, TransitionGroup, useAttrs as useAttrs$1, shallowRef, nextTick, toRef, withDirectives, mergeProps, withModifiers, vShow, Transition, shallowReactive, useSSRContext, getCurrentInstance, onUnmounted, Text, isVNode, isRef, render } from 'vue';
import { b as buildProp, a as buildProps, d as definePropType, f as formContextKey, c as formItemContextKey, e as addUnit, i as isBoolean, w as withInstall, g as withNoopInstall, V as ValidateComponentsMap, v as view_default, h as hide_default, E as ElIcon, j as circle_close_default, k as isNumber, l as iconPropType, T as TypeComponentsMap, m as withInstallFunction, u as useZIndex, n as defaultInitialZIndex, z as zIndexContextKey, o as mutable, p as useDeprecated, q as loading_default, r as TypeComponents, s as EVENT_CODE, _ as _export_sfc, t as isElement } from './base-45cc502a.mjs';
import { isString, NOOP, isArray, isFunction, isObject } from '@vue/shared';
import { u as useNamespace, d as debugWarn, t as throwError, b as useId, e as useSupabaseClient, f as useSupabaseUser, g as useRouter, a as defaultNamespace, n as namespaceContextKey } from '../server.mjs';
import { castArray, isNil, get, set, fromPairs, clone } from 'lodash-unified';
import AsyncValidator from 'async-validator';
import { useResizeObserver, refDebounced, useEventListener, isClient, useTimeoutFn } from '@vueuse/core';
...
var Form = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/form/src/form.vue"]]);
...
var FormItem = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/form/src/form-item.vue"]]);
...
var Input = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/input/src/input.vue"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const loginForm = reactive({
      email: "philipswiezak@gmail.com",
      password: "xYdE.7FNCagaVBT"
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-3/4 flex items-center justify-center" }, _attrs))}><div class="flex items-center w-80 flex-col bg-white rounded-2xl shadow-2xl"><div class="bg-[#1C3452] flex items-center justify-center m-6"><div class=""></div></div>`);
      _push(ssrRenderComponent(_component_el_form, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="w-full flex justify-center"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_button, {
              type: "primary",
              onClick: ($event) => submitForm(unref(loginFormRef))
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Login`);
...
//# sourceMappingURL=Login-e0114848.mjs.map
